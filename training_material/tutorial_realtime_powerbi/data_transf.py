...
class TransformerDataGenerator:
    ...
    """
    ....
    Module power output have many dependencies like solar irradiance, cell temperature, temperature coefficient  and standard test-training_material conditions(STC)
    Here In this case, I have considered STC parameters to evaluate the module power output.
    pdc0: power at standard test-training_material condition
